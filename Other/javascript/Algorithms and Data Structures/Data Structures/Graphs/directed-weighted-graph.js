 ...
 * 
 * Below is an implementation of an Directed - Weighted graph.
 * 
 * addVertex, removeVertex, removeEdge is same as the Directed Unweighted Graph.
 */
...
class DirectedWeightedGraph {
    ...
    addEdge(source, destination, weight) {
        ...
        if (!this.adjacencyList[source].includes(destination)) {
            this.adjacencyList[source].push({vertex: destination, weight: weight});
        }
